...
const CartSidebarModal = () => {
  ...
  // Pastikan ada fallback array kosong agar tidak error jika undefined
  const cartItems = useAppSelector((state: any) => state.cartReducer.items) || [];

  // Mengambil total harga dari Redux
    ...
    >
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          <div className="sticky top-0 bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b border-gray-3 mb-7.5 z-10">
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0 z-10">
