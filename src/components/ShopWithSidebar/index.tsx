...
const ShopWithSidebar = () => {
  ...
  useEffect(() => {
    ...
    // Menutup sidebar ketika klik di luar daerah sidebar
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="xl:max-w-[870px] w-full">
              ...
              >
                {products
                  // Filter produk berdasarkan category_id dari database
                  .filter((item: any) => {
                  ...
                  .map((item: any) => (
                    <SingleGridItem
                      key={item.id}
                      item={{
                        ...item, // 🔥 1. BAWA SELURUH DATA ASLI LARAVEL DATABASE (Deskripsi, Estimasi, dll)
                        id: item.id,
                        title: item.name,
                        reviews: 0,
                        price: item.price,
              ...
              <div className="flex justify-center mt-15">
                <div className="bg-white shadow-1 rounded-md p-2">
                  <ul className="flex items-center">
                    ...
                    <li>
                      <a href="#" className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-blue text-white hover:text-white hover:bg-blue">1</a>
                    </li>
                    <li>
                      <a href="#" className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-blue">2</a>
                    </li>
                    <li>
                      <a href="#" className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-blue">3</a>
                    </li>
                    <li>
                      <button
                        id="paginationRight"
